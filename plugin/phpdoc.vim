...
fun! ClassHeader()
	...
	let @z = l:indent . "/**\n"
"-NIT MAJ-	let @z=@z . l:indent . " *\n"
	let @z=@z . l:indent . " * This is the short Description for the Class\n"
	let @z=@z . l:indent . " *\n"
	let @z=@z . l:indent . " * This is the long description for the Class\n"
	let @z=@z . l:indent . " *\n"
    
    let @z=@z . l:indent . " * @author    Nicolas Thouvenin <touv at ouvaton dot fr>\n"
    let @z=@z . l:indent . " * @copyright LGPL\n"
    let @z=@z . l:indent . " * @version   $" . "Id$\n"
	let @z=@z . l:indent . " * @package   Package\n"

"-NIT MAJ-	let @z=@z . l:indent . " * @author\t\tKarl Heinz Marbaise <khmarbaise@gmx.de>\n"
"-NIT MAJ-	let @z=@z . l:indent . " * @copyright\t(c) 2003 by Karl Heinz Marbaise\n"
"-NIT MAJ-	" prevent RCS/CVS to expand the Id Keyword.
"-NIT MAJ-	let @z=@z . l:indent . " * @version\t\t$" . "Id$\n"
"-NIT MAJ-	let @z=@z . l:indent . " * @package\t\tPackage\n"
"-NIT MAJ-	let @z=@z . l:indent . " * @subpackage\tSubPackage\n"
"-NIT MAJ-	let @z=@z . l:indent . " * @see\t\t\t??\n"
	let @z=@z . l:indent . " */\n"
	put! z
	"--------------------------------------------------
...
"-NIT MAJ-	let @z=@z . l:indent . "*\n"
"-NIT MAJ-	let @z=@z . l:indent . "* This is the long description for the Class\n"
	let @z=@z . l:indent . "*\n"
